...
void Demo::BuildColoredCube() {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("Treeleaf.png", &width, &height, 0, SOIL_LOAD_RGBA);
...
void Demo::DrawColoredCube()
{
	...
	glUniform3f(objectColorLoc, 0.6f, 0.3f, 0.1f);
	...
	model2 = glm::scale(model2, glm::vec3(1, 0.25, 1));
	...
	glm::mat4 model3;
	model3 = glm::translate(model3, glm::vec3(0, 0.65, 0));
	model3 = glm::scale(model3, glm::vec3(0.75, 0.25, 0.75));
	...
	glm::mat4 model4;
	model4 = glm::translate(model4, glm::vec3(0, 0.75, 0));
	model4 = glm::scale(model4, glm::vec3(0.5, 0.25, 0.5));
